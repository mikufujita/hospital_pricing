...
class file_search(CrawlSpider):
    ...
    rules = (
        ...
        Rule(LinkExtractor(allow=("xls","XLS","xlsx","XLSX","csv","CSV","ashx","ASHX","aspx", "ASPX" ".html", "pdf", "PDF","txt", "TXT" "get$"),deny_extensions = ("jpg","png")),callback="parse_items",follow=False),
