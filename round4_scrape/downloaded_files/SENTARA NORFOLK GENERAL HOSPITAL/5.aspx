...
></div>
	...
	<div class="template  " ng-init = '$root.meta = {title: "Pay Your Doctor Bill | Sentara Healthcare",description: "Top Hospitals and Quality Health Care in Virginia and North Carolina from Sentara.",keywords: "sentara, healthcare"}'>
		...
		<div id="main-content" class="content-restrict -g">
			<div class="-u -m-1 -t-1-3 -d-1-4 nav-tertiary">
				<div class="nav-tertiary-body">
					<ng-include src="generateWidgetURL('/Widgets/System/Tertiary-Navigation.aspx', true)" ng-init='pagePath="sentara/universal/en/billing/pay your doctor bill online"; pageFolder="sentara/universal/en/billing"; '></ng-include>
					<div class="-m-hide">
			...
			<div class="-u -m-1 -t-2-3 -d-3-4">
					...
					<div  class="module module-m79-body-text" ng-controller="none" module="BODY">
						<h1 class="page_title" >Pay Your Doctor Bill Online</h1>
...
<p>We offer multiple ways to pay your doctor bill, please <a href="#" ng-click="openOutOfRegionModal($event)">select a region</a> to determine which options are available to you.</p></div></div>
					</div>
				</div>
