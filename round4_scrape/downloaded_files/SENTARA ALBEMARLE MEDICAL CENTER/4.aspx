...
></div>
	...
	<div class="template location-confirmation-required" ng-init = '$root.meta = {title: "Billing Information | Sentara Healthcare",description: "Top Hospitals and Quality Health Care in Virginia and North Carolina from Sentara.",keywords: "sentara, healthcare"}'>
    <div class="template-content-page-tertiary-gateway">
        ...
        <div id="main-content" class="content-restrict -g">
            <div class="-u -m-1 -t-1-3 -d-1-4 nav-tertiary">
                <div class="nav-tertiary-body">
                    <ng-include src="generateWidgetURL('/Widgets/System/Tertiary-Navigation.aspx', true)" ng-init='pagePath="sentara/universal/en/billing"; pageFolder="sentara/universal/en/billing"; '></ng-include>
                    <div holder="M1" breakpoint="tablet|desktop|wide">
                        ...
                        <div class="-u -m-1 -t-2-3 -d-3-4">
                                <div class="-g">
                    <div class="-u -m-1  page-content">
                        <div class="search_content">
                            <div  class="module module-m79-body-text" ng-controller="none" module="BODY" min-height="153">
                                <h1 class="page_title" >Billing Information</h1>
                                <div>
                                                                    </div>
                                <div class="page_description textresize"><div class='wysiwyg-content' wysiwyg-video-resizer google-analytics-container send-data-from-elem-clicked-only="true"><p>Sentara offers multiple ways to pay your bill - online, through the mail, on the phone, or at a payment location near you.</p>
<p>You may receive one of two bill types: a <a href="/billing/pay-your-doctor-bill-online.aspx">physician bill</a> for services provided at your doctor's office and/or a <a href="/billing/pay-your-hospital-bill-online.aspx">hospital bill</a> for services provided at one of our hospitals.</p>
<p>If you have questions, please <a href="/billing/contact-us.aspx">contact us</a>.</p></div></div>
                            </div>
                            <div class="module module-cta-links-container" ng-controller="none" module="M104">
	 
	<div class="-g">
				<div class="-u -m-1 -d-1-3">
				<div class="module module-cta-link-small">
					<div class="icon-right-arrow"></div>
                    <a href="/billing/pay-your-hospital-bill-online.aspx"  >
							<img ng-src="/Assets/Img/Icons/Gateway/cta-insuranceandbilling.png" alt="Image Cta Insuranceandbilling" />
						    
                            						<span>Pay Your Hospital Bill</span>
                        </a>
				</div>
			</div>
						<div class="-u -m-1 -d-1-3">
				<div class="module module-cta-link-small">
					<div class="icon-right-arrow"></div>
                    <a href="/billing/pay-your-doctor-bill-online.aspx"  >
							<img ng-src="/Assets/Img/Icons/Gateway/cta-insuranceandbilling.png" alt="Image Cta Insuranceandbilling" />
						    
                            						<span>Pay Your Doctor Bill</span>
                        </a>
				</div>
			</div>
				</div>
                            ...
                            <div  class="module module-m79-body-text textresize" ng-controller="none" module="BODY" min-height="300">
                                <div class='wysiwyg-content' wysiwyg-video-resizer google-analytics-container send-data-from-elem-clicked-only="true"><h3>Helpful links:</h3>
<ul>
<li><a href="/billing/frequently-asked-questions.aspx">Frequently asked questions</a></li>
<li><a href="/billing/financial-assistance.aspx">Financial assistance</a></li>
<li><a href="/billing/understanding-prices.aspx">Understanding health care costs</a></li>
</ul></div>                            </div>
                        </div>
                    </div>
                                    </div>
