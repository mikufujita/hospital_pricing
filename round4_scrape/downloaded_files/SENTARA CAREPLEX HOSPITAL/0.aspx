...
></div>
	...
	<div class="template " ng-init = '$root.meta = {title: "Financial Assistance | Sentara Healthcare",description: "Top Hospitals and Quality Health Care in Virginia and North Carolina from Sentara.",keywords: "sentara, healthcare"}'>
		...
		<div id="main-content" class="content-restrict -g">
			<div class="-u -m-1 -t-1-3 -d-1-4 nav-tertiary">
				<div class="nav-tertiary-body">
					<ng-include src="generateWidgetURL('/Widgets/System/Tertiary-Navigation.aspx', true)" ng-init='pagePath="sentara/universal/en/billing/financial assistance"; pageFolder="sentara/universal/en/billing"; '></ng-include>
					<div class="-m-hide">
						<ng-include src="generateWidgetURL('/Widgets/Contact-Us/Contact-Us.aspx', true)"></ng-include>
					</div>
				</div>
			</div>
				...
				<div class="-g">
					<div class="-u -m-1 -d-2-3">
						<div class="page-content">
							<div  class="module module-m79-body-text" ng-controller="none" module="BODY" min-height="153">
								<h1 class="page_title" >Financial Assistance - Sentara Hospital Facilities</h1>
								<div class="page_description textresize"><div class='wysiwyg-content' wysiwyg-video-resizer google-analytics-container send-data-from-elem-clicked-only="true"><p>At Sentara, we provide quality care to all patients regardless of their ability to pay. We understand that health care expenses are often unexpected and paying for services can be overwhelming. If you cannot pay your bill, we can help. <strong>Please select your hospital&nbsp;facility below:</strong></p>
<h2>Hospitals</h2>
<ul>
<li><a href="/billing/financial-assistance/sentara-albemarle-medical-center.aspx">Sentara Albemarle Medical Center</a></li>
<li><a href="/billing/financial-assistance/hampton-roads-northern-virginia.aspx">Sentara CarePlex Hospital</a></li>
<li><a href="/billing/financial-assistance/sentara-halifax-regional-hospital.aspx">Sentara Halifax Regional Hospital</a></li>
<li><a href="/billing/financial-assistance/hampton-roads-northern-virginia.aspx">Sentara Leigh Hospital</a></li>
<li><a href="/billing/financial-assistance/sentara-martha-jefferson-hospital.aspx">Sentara Martha Jefferson Hospital</a></li>
<li><a href="/billing/financial-assistance/hampton-roads-northern-virginia.aspx">Sentara Norfolk General Hospital</a></li>
<li><a href="/billing/financial-assistance/hampton-roads-northern-virginia.aspx">Sentara Northern Virginia Medical Center</a></li>
<li><a href="/billing/financial-assistance/hampton-roads-northern-virginia.aspx">Sentara Obici Hospital</a></li>
<li><a href="/billing/financial-assistance/hampton-roads-northern-virginia.aspx">Sentara Princess Anne Hospital</a></li>
<li><a href="/billing/financial-assistance/sentara-rmh-medical-center.aspx">Sentara RMH Medical Center</a></li>
<li><a href="/billing/financial-assistance/hampton-roads-northern-virginia.aspx">Sentara Virginia Beach General Hospital</a></li>
<li><a href="/billing/financial-assistance/hampton-roads-northern-virginia.aspx">Sentara Williamsburg Regional Medical Center</a></li>
</ul>
<h2>Outpatient Surgical Hospitals</h2>
<ul>
<li><a href="/billing/financial-assistance/hampton-roads-northern-virginia.aspx">Sentara Leigh Hospital&nbsp;Ambulatory Surgery Center</a></li>
<li><a href="http://www.vbasc.com/patient-information/financial-information/" target="_blank">Virginia Beach Ambulatory Surgery Center</a></li>
<li><a href="/billing/financial-assistance/princess-anne-asc.aspx">Princess Anne Ambulatory Surgery Center</a></li>
<li><a href="/billing/financial-assistance/obici-asc.aspx">Obici Ambulatory Surgery Center</a></li>
<li><a href="/billing/financial-assistance/hampton-roads-northern-virginia.aspx">Sentara Port Warwick Ambulatory Surgery Center</a></li>
<li><a href="https://www.careplexortho.com/patients/financial-assistance/" target="_blank">CarePlex Orthopaedic Ambulatory Surgery Center</a></li>
<li><a href="/billing/financial-assistance/hampton-roads-northern-virginia.aspx">Geddy Outpatient Center at SWRMC</a></li>
<li><a href="https://lakeridgesurgerycenter.com/patient-information/financial-assistance-policy/" target="_blank">Sentara Lake Ridge</a></li>
<li><a href="/billing/financial-assistance/sentara-martha-jefferson-outpatient-surgery-center.aspx">Sentara Martha Jefferson Outpatient Surgery Center</a></li>
</ul></div></div>
							</div>
							<div class="module module-callout-buttons-container" ng-controller="none">
    <div class="-g">
                		    </div>
</div>
							<div  class="module module-m79-body-text textresize" ng-controller="none" module="BODY" min-height="300">
								<div class='wysiwyg-content' wysiwyg-video-resizer google-analytics-container send-data-from-elem-clicked-only="true"></div>							</div>
						</div>
					</div>
					<div class="-u -m-1 -d-1-3">
						<!-- Cannot load asset ''. -->
					</div>
				</div>
			</div>
			<div class="-u -m-hide -t-1-3 -d-1-4"></div>
			<div class="-u -m-hide -t-2-3 -d-3-4">
