...
></div>
	...
	<div class="template " ng-init = '$root.meta = {title: "Understanding Health Care Costs | Sentara Healthcare",description: "Top Hospitals and Quality Health Care in Virginia and North Carolina from Sentara.",keywords: "sentara, healthcare"}'>
	<div class="template-content-page-accordion-menu">
	...
	<div class="content-restrict">
		...
		<div id="main-content" class="content-restrict -g">
			<div class="-u -m-1 -t-1-4 nav-tertiary">
				<div class="nav-tertiary-body">
					
					<ng-include src="generateWidgetURL('/Widgets/System/Tertiary-Navigation.aspx', true)" ng-init='pagePath="sentara/universal/en/billing/understanding prices"; pageFolder="sentara/universal/en/billing"; '></ng-include>
					
					<div holder="M1" breakpoint="tablet|desktop|wide">
			...
			<div class="-u -m-1 -t-2-3 -d-3-4">
								<div class="-g">
					<div class="-u -m-1 -d-2-3">
						<div class="page-content">
							
							<div class="module module-m79-body-text" ng-controller="none" module="BODY" >
								<h1 class="page_title" >Understanding Health Care Costs</h1>
								<div>
																	</div>
								<div class="page_description textresize"><div class='wysiwyg-content' wysiwyg-video-resizer google-analytics-container send-data-from-elem-clicked-only="true"><p>We understand that coming to the hospital can be a stressful time and understand the bills associated with your care can be confusing. At Sentara, we are committed to providing transparent pricing information to help patients and customers make informed health care decisions and ease some of the stress.</p>
<p>If you have questions about pricing or your hospital bill, please <a href="/billing/contact-us.aspx">contact our billing department</a>.</p></div></div>
							</div>
							
							
							<div  class="module module-m79-body-text" ng-controller="none" module="BODY">
								<div class="page_description textresize"><div class='wysiwyg-content' wysiwyg-video-resizer google-analytics-container send-data-from-elem-clicked-only="true"></div></div>
							</div>
							
							
							<div class="module module-accordion-text" ng-controller="none">
		<ul class="acco-root"  acco-root send-google-tag-analytic="">
				<li acco-item>
						<div class="acco-expander" acco-expander>
                <span>If you have health insurance</span>
			</div>
						<div class="pane">
		        <div class='wysiwyg-content' wysiwyg-video-resizer google-analytics-container send-data-from-elem-clicked-only="true"><p>The amount you are responsible for paying depends on your insurance plan. The most accurate estimate will be provided by your health insurance provider. Your financial responsibility will depend on your medical plan benefits and may include a deductible, coinsurance or copays. It's important to contact your insurance company before a medical procedure. Here are some of the most common plans:</p>
<ul>
<li><a href="http://www.optimahealth.com/estimator/Pages/default.aspx" target="_blank">Optima Health</a></li>
<li><a href="https://www.aetna.com/" target="_blank">Aetna</a></li>
<li><a href="https://www.anthem.com/health-insurance/home/overview" target="_blank">Anthem</a></li>
<li><a href="http://www.cigna.com/" target="_blank">Cigna</a></li>
<li><a href="http://coventryhealthcare.com/" target="_blank">Coventry</a></li>
<li><a href="https://www.humana.com/" target="_blank">Humana</a></li>
<li><a href="http://www.uhc.com/" target="_blank">United HealthCare</a></li>
</ul></div>			</div>
		</li>
				<li acco-item>
						<div class="acco-expander" acco-expander>
                <span>If you don't have insurance</span>
			</div>
						<div class="pane">
		        <div class='wysiwyg-content' wysiwyg-video-resizer google-analytics-container send-data-from-elem-clicked-only="true"><p>You may qualify for financial assistance program. Learn more about <a href="/billing/financial-assistance.aspx">financial assistance at Sentara</a>.</p></div>			</div>
		</li>
				<li acco-item>
						<div class="acco-expander" acco-expander>
                <span>Estimating hospital charges</span>
			</div>
						<div class="pane">
		        <div class='wysiwyg-content' wysiwyg-video-resizer google-analytics-container send-data-from-elem-clicked-only="true"><p>Patients with insurance should understand their health insurance benefits and out-of-pocket costs for health care services &ndash; please contact your health insurance provider directly for this information. If you don't have insurance, <a href="/billing/financial-assistance.aspx">you may qualify for financial assistance</a> at Sentara.</p>
<p>Estimating the price/charge of a health care procedure can be complicated. The charges for services is based on many factors that vary from hospital to hospital and are usually revised on an annual basis.</p>
<p>Estimates include hospital pricing/charges only. They do not include physician charges, rehabilitation, home health or other pre- and post-operative care. Estimates also assume services are provided without complications.</p>
<p>The final bill you receive will include charges for actual services provided to you. These charges may differ from the estimate. You will be responsible for any additional charges in excess of the estimate. The estimates will not provide an insurance benefit review.</p>
<p>As required by the Centers for Medicare and Medicaid Services <a href="/Assets/Pdf/Patient-Guide/Billing/2019-Sentara-Pricing-Transparency-Hampton-Roads-Northern-VA.csv" target="_blank" google-analytics-submit data-google-key-0="event" data-google-value-0="ChargeMasterClick" data-google-key-1="CTAName" data-google-value-1="Universal ChargeMaster">you can see the charges for Sentara hospitals in your area</a>.</p></div>			</div>
		</li>
				<li acco-item>
						<div class="acco-expander" acco-expander>
                <span>Additional Information</span>
						...
						<div class="pane">
		        <div class='wysiwyg-content' wysiwyg-video-resizer google-analytics-container send-data-from-elem-clicked-only="true"><p>As the healthcare landscape has changed, so have the costs charged directly to the patient. The amount you may pay depends upon a number of factors, and we want to be sure you are always kept informed and help you manage your healthcare costs. These websites provide information regarding average Virginia hospital charges and average insurance allowances for a number of medical services.</p>
<ul>
<li><a href="http://www.vapricepoint.org/" target="_blank">VHHA PricePoint</a></li>
<li><a href="http://www.vhi.org/healthcarepricing/" target="_blank">Virginia Health Information</a></li>
<li><a href="http://www.healthcostinstitute.org/" target="_blank">Health Care Cost Institute</a></li>
<li><a href="http://www.cms.gov/Research-Statistics-Data-and-Systems/Statistics-Trends-and-Reports/Medicare-Provider-Charge-Data/index.html" target="_blank">Medicare Provider Utilization and Payment Data</a></li>
</ul></div>			</div>
		</li>
			</ul>
</div>
							...
							<div  class="module module-m79-body-text" ng-controller="none" module="BODY">
								<div class="page_description textresize"><div class='wysiwyg-content' wysiwyg-video-resizer google-analytics-container send-data-from-elem-clicked-only="true"></div></div>
														...
														<div holder="M4" breakpoint="mobile|tablet"></div>
							<div holder="M90" breakpoint="mobile|tablet"></div>
						</div>
					</div>
					<div class="-u -m-1 -d-1-3 restrict">
												<div holder="M4" breakpoint="desktop|wide">
							
																												
						</div>
						<div holder="M90" breakpoint="desktop|wide">
						...
						<div holder="M1" breakpoint="mobile"></div>
					</div>
				</div>
			</div>
			<div class="-g -m-hide -t-1 -d-1">
				<div class="-u -m-hide -t-1-4 -d-1-4"></div>
				<div class="-u -m-hide -t-3-4 -d-3-4" ng-if="!BREAKPOINT.mobile">
